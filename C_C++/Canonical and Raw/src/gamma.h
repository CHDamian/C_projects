 ...
 * ruchu i jest przynajmniej jedno pole na którym ruch byłby legalny.
 * @param[in] g       – wskaźnik na strukturę przechowującą stan gry,
 * @param[in] player  – numer gracza, liczba dodatnia niewiększa od wartości
 *                      @p players z funkcji @ref gamma_new.
...
/** @brief Zwraca plansze.
 * Zwraca wskaźnik na przechowywaną plansze.
 * @param[in] g       – wskaźnik na strukturę przechowującą stan gry.
 * @return Wskaźnik na plansze lub NULL, 
 * jeśli @g wskazuje na NULL.
 */
matrix* gamma_get_matrix(gamma_t *g);

/** @brief Zwraca graczy.
 * Zwraca wskaźnik na strukture przechowującą graczy.
 * @param[in] g       – wskaźnik na strukturę przechowującą stan gry.
 * @return Wskaźnik na strukture lub NULL, 
 * jeśli @g wskazuje na NULL.
 */
